...
$url = 'https://github.com/RyanYuuki/AnymeX/releases/download/v3.1.2/AnymeX-Windows.zip'
$checksum = '425148F983E967820EB029BAE81514F8652521300256F917284E2710EE94ADC6'
