...
$url = 'https://github.com/RyanYuuki/AnymeX/releases/download/v3.1.5/AnymeX-Windows.zip'
$checksum = 'F22121F46945090BBB3A685073DA75A56B00B3150C9D61AEBE77A108B7B1DEC1'
