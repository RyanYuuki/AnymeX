...
mixin _$ProxySettings {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ProxySettings);
  }
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case ProxySettings_NoProxy() when noProxy != null:
        return noProxy(_that);
      case ProxySettings_CustomProxyList() when customProxyList != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case ProxySettings_NoProxy():
        return noProxy(_that);
      case ProxySettings_CustomProxyList():
        return customProxyList(_that);
    }
  }
...
class ProxySettings_NoProxy extends ProxySettings {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is ProxySettings_NoProxy);
  }
...
class ProxySettings_CustomProxyList extends ProxySettings {
  const ProxySettings_CustomProxyList(final List<CustomProxy> field0)
      : _field0 = field0,
        super._();
  ...
  $ProxySettings_CustomProxyListCopyWith<ProxySettings_CustomProxyList>
      get copyWith => _$ProxySettings_CustomProxyListCopyWithImpl<
          ProxySettings_CustomProxyList>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ProxySettings_CustomProxyList &&
...
/// @nodoc
abstract mixin class $ProxySettings_CustomProxyListCopyWith<$Res>
    implements $ProxySettingsCopyWith<$Res> {
  factory $ProxySettings_CustomProxyListCopyWith(
          ProxySettings_CustomProxyList value,
          $Res Function(ProxySettings_CustomProxyList) _then) =
      _$ProxySettings_CustomProxyListCopyWithImpl;
  @useResult
...
mixin _$RedirectSettings {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is RedirectSettings);
  }
...
class $RedirectSettingsCopyWith<$Res> {
  $RedirectSettingsCopyWith(
      RedirectSettings _, $Res Function(RedirectSettings) __);
}
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    switch (_that) {
      case RedirectSettings_NoRedirect() when noRedirect != null:
        return noRedirect(_that);
      case RedirectSettings_LimitedRedirects() when limitedRedirects != null:
  ...
  TResult map<TResult extends Object?>({
    ...
    switch (_that) {
      case RedirectSettings_NoRedirect():
        return noRedirect(_that);
      case RedirectSettings_LimitedRedirects():
        return limitedRedirects(_that);
    }
  }
...
class RedirectSettings_NoRedirect extends RedirectSettings {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RedirectSettings_NoRedirect);
  }
...
class RedirectSettings_LimitedRedirects extends RedirectSettings {
  ...
  $RedirectSettings_LimitedRedirectsCopyWith<RedirectSettings_LimitedRedirects>
      get copyWith => _$RedirectSettings_LimitedRedirectsCopyWithImpl<
          RedirectSettings_LimitedRedirects>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RedirectSettings_LimitedRedirects &&
...
/// @nodoc
abstract mixin class $RedirectSettings_LimitedRedirectsCopyWith<$Res>
    implements $RedirectSettingsCopyWith<$Res> {
  factory $RedirectSettings_LimitedRedirectsCopyWith(
          RedirectSettings_LimitedRedirects value,
          $Res Function(RedirectSettings_LimitedRedirects) _then) =
      _$RedirectSettings_LimitedRedirectsCopyWithImpl;
  @useResult
  $Res call({int field0});
}
