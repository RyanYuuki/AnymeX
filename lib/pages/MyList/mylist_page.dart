...
class MyListState extends State<MyList> with SingleTickerProviderStateMixin {
  ...
  Widget _buildMediaGrid(MediaType mediaType, dynamic carouselData) {
    ...
    return GridView.builder(
        padding: EdgeInsets.all(_currentLayout == GridLayout.single ? 16 : 12),
        itemCount: carouselData?.length ?? 0,
        physics: const BouncingScrollPhysics(),
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: _getCrossAxisCount(),
          mainAxisExtent: getCardHeight(),
          crossAxisSpacing: _currentLayout == GridLayout.single ? 16 : 12,
          mainAxisSpacing: _currentLayout == GridLayout.single ? 16 : 12,
        ),
          ...
          return AnimatedScale(
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  // );
                  _showDetailDialog(context, itemData);
                },
                      ...
                      ClipRRect(
                        ...
                        child: Hero(
                          ...
                          child: CachedNetworkImage(
                            ...
                            height: _currentLayout == GridLayout.single
                                ? (getCardHeight() - 70)
                                : (getCardHeight() - 50),
                            width: double.infinity,
                            alignment: _currentLayout == GridLayout.single
                                ? Alignment.topCenter
                                : Alignment.center,
                            fit: BoxFit.cover,
                          ),
