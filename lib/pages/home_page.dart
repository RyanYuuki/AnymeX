  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
      ...
      builder: (context, Box loginBox, _) {
        final userInfo = loginBox.get('userInfo', defaultValue: ['Guest', 'Guest', 'null']);
        ...
        return ValueListenableBuilder(
          ...
          builder: (context, Box appBox, _) {
            final List<dynamic>? watchingAnimeList = appBox.get('currently-watching');
            final List<dynamic>? readingMangaList = appBox.get('currently-reading');
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage: hasAvatarImage ? FileImage(File(avatarImagePath)) : null,
