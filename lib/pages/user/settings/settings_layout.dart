...
import 'package:anymex/pages/user/settings/layout_subs/resize_tabbar.dart';
import 'package:anymex/pages/user/settings/modals/tile_with_slider.dart';
...
class _LayoutPageState extends State<LayoutPage> {
  ...
  double tabBarRoundness =
      Hive.box('app-data').get('radiusMultiplier', defaultValue: 1.0);
        ...
        children: [
          ...
          TileWithSlider(
            ...
            onChanged: (newValue) {
              ...
              Hive.box('app-data').put('radiusMultiplier', newValue);
            },
