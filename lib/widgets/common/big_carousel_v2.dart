...
class _BigCarouselV2State extends State<BigCarouselV2> {
            ...
            children: [
              CarouselSlider.builder(
                ...
                itemBuilder: (context, index, realIndex) {
                  ...
                  return _buildLandscapeCard(context, item, isActive);
                },
                options: CarouselOptions(
                  height: getResponsiveSize(context,
                      mobileSize: 220, desktopSize: 400),
  ...
  Widget _buildLandscapeCard(BuildContext context, Media media, bool isActive) {
    final colorScheme = Theme.of(context).colorScheme;
              ...
              Hero(
                ...
                child: CachedNetworkImage(
                  ...
                  errorWidget: (context, url, error) => Container(
                    color: colorScheme.surfaceContainerHighest,
                    child: Icon(Iconsax.image, color: colorScheme.onSurface),
                  ),
                ),
              ),
              Positioned(
