...
class _AnymeXAnimatedLogoState extends State<AnymeXAnimatedLogo>
  ...
  void initState() {
    ...
    // Fill animation (0.5s at 2.8s) - bottom to top
  ...
  Widget _buildLogo() {
    ...
    final Color logoColor = widget.color ?? Colors.blue;
    ...
    // Logo SVG string with stroke animation and bottom-to-top fill
    final logoSvg = '''
      <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
        <defs>
          ...
          <linearGradient id="fillGradient" x1="0%" y1="100%" x2="0%" y2="0%">
            <stop offset="0%" stop-color="${_colorToRgba(logoColor, 1.0)}" />
            <stop offset="${100 - fillHeight}%" stop-color="${_colorToRgba(logoColor, 0.0)}" />
