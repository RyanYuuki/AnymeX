    ...
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: AnymexText(
            text:
                'Keep your watch position in sync across all your devices. '
        ...
        const SizedBox(height: 4),
        Obx(() => _SyncCard(controller: controller)),
      ],
    );
  }
}
...
class _SyncCard extends StatelessWidget {
          ...
          children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: Row(
                  children: [
                    _buildIcon(colors, isSignedIn, isSyncing),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          AnymexText(
                            text: _subtitle(isSignedIn, isSyncing, lastSync),
                            color: isSignedIn
                                ? colors.primary
  ...
  String _subtitle(bool isSignedIn, bool isSyncing, DateTime? lastSync) {
  ...
  Widget _buildIcon(dynamic colors, bool isSignedIn, bool isSyncing) {
    if (isSyncing) {
      return SizedBox(
        width: 56,
        height: 56,
  ...
  void _showManageSheet(
      BuildContext context, CloudSyncController controller) {
    final colors = context.colors;
