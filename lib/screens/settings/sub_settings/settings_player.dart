                                  ...
                                  content: Column(
                                    children: [
                                      CustomSwitchTile(
                                          ...
                                          switchValue: settings.preferences.get(
                                              'useOldPlayer',
                                              defaultValue: false),
                                          onChanged: (val) {
                                            settings.preferences
                                      ...
                                      CustomSwitchTile(
                                          ...
                                          switchValue: PlayerKeys.useLibass
                                              .get<bool>(false),
                                          onChanged: (val) {
                                      ...
                                      CustomSwitchTile(
                                          ...
                                          switchValue:
                                              settings.defaultPortraitMode,
                                          onChanged: (val) => settings
                                              .defaultPortraitMode = val),
                                      CustomTile(
                                        padding: 10,
                                        isDescBold: true,
                                        icon: Icons.speed,
                                      ...
                                      CustomSwitchTile(
                                          ...
                                          switchValue:
                                              settings.enableSwipeControls,
                                          onChanged: (val) => settings
                                              .enableSwipeControls = val),
                                      CustomSliderTile(
                                        sliderValue:
                                            settings.seekDuration.toDouble(),
                                        max: 50,
                                        divisions: 10,
                                      ...
                                      CustomSliderTile(
                                        sliderValue:
                                            settings.skipDuration.toDouble(),
                                        max: 120,
                                        divisions: 24,
                                      ...
                                      CustomSliderTile(
                                        ...
                                        divisions: 20,
                                        label:
                                            settings.markAsCompleted.toString(),
                                        onChanged: (double value) {
                                          setState(() {
