...
class _SettingsExtensionsState extends State<SettingsExtensions> {
  ...
  Widget _buildPluginRequiredPlaceholder(String managerName) {
    ...
    // On iOS: show server bridge login/register instead of download prompt.
    if (Platform.isIOS) {
      return _buildIosServerBridgePanel(colors);
    }
  ...
  Widget _buildIosServerBridgePanel(ColorScheme colors) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Sign in to use extensions on iOS via the cloud server.',
              textAlign: TextAlign.center,
              style: TextStyle(
                fontSize: 13,
                color: colors.onSurfaceVariant,
              ...
              children: [
                Expanded(
                  child: FilledButton.icon(
                    onPressed: () => _showServerAuthSheet(register: false),
                ...
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () => _showServerAuthSheet(register: true),
  ...
  void _showServerAuthSheet({required bool register}) {
    final colors = context.colors;
    final pm = PluginManager();
