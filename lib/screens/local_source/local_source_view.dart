...
class _WatchOfflineState extends State<WatchOffline> {
  ...
  Widget _buildModernViewSwitcher(LocalSourceController controller) {
    return Container(
      width: double.infinity,
      decoration: BoxDecoration(
        color: Get.theme.colorScheme.surfaceContainerHighest.opaque(0.6),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: Get.theme.colorScheme.outline.opaque(0.12),
          width: 1,
        ),
      ),
      padding: const EdgeInsets.all(4),
                    ...
                    if (canChangeDirectory) ...[
                      ...
                      AnimatedOpacity(
                        ...
                        child: Icon(
                          ...
                          size: 16,
                          color: theme.colorScheme.onPrimary.opaque(0.7),
                        ),
                      ),
                    ],
                  ],
  ...
  Widget _buildInfoChip(ThemeData theme, String text, IconData icon,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: isFilled
            ? theme.colorScheme.primary
            : theme.colorScheme.secondary.opaque(0.1, iReallyMeanIt: true),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: theme.colorScheme.secondary.opaque(0.3, iReallyMeanIt: true),
        ),
      ),
      child: Row(
        mainAxisSize: MainAxisSize.min,
